package com.abulnes.trucker_app.presentation.screens.home.forgot_password_recovery
...
@Composable
fun ForgotPasswordProfileScreen(
    onGoBack: () -> Unit,
...
@Preview
@Composable
fun ForgotPasswordSProfileScreenPreview() {
    TruckerAppTheme {
        ForgotPasswordProfileScreen({},{})
    }
